...
export function MyActiveRoles() {
  const activeRoles = [
    {
      ...
      description: "Full access to approve requests and manage roles and teams",
    ...
    {
      name: "Finance Database - Read",
      description: "Read access to financial reports for team budget tracking",
      grantedDate: "2025-09-20",
  ...
  const pendingRequests = [
    {
      id: "REQ-1248",
      roleName: "Advanced Analytics Platform",
