...
-- NOTE: No FK to jit.Roles(RoleId) because Roles is SCD-2 versioned and RoleId is non-unique.
-- RoleId integrity is enforced by application/stored procedures against active role versions.
