...
SELECT @RoleId2 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Data Warehouse Reader' AND IsActive = 1;
SELECT @RoleId3 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Advanced Analytics' AND IsActive = 1;
