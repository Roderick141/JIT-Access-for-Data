...
-- Get role IDs
SELECT @RoleId1 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Read-Only Reports' AND IsActive = 1;
SELECT @RoleId2 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Advanced Analytics' AND IsActive = 1;
SELECT @RoleId3 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Data Warehouse Reader' AND IsActive = 1;
SELECT @RoleId4 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Temporary Query Access' AND IsActive = 1;
SELECT @RoleId5 = RoleId FROM [jit].[Roles] WHERE RoleName = 'Data Export Access' AND IsActive = 1;
