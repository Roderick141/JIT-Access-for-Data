...
PRINT '  5. Eligibility rules (department, division, team-based)'
PRINT '  6. Expired grants (for testing expiry job)'
PRINT ''
PRINT 'Test users:'
PRINT '  - DOMAIN\john.smith'
PRINT '  - DOMAIN\mike.wilson'
PRINT '  - DOMAIN\alex.taylor'
